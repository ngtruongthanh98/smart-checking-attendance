...
if (!isset($_SESSION['class_list_ses']) && !isset($_SESSION['mysesi']) 
 && !isset($_SESSION['id'])             && !isset($_SESSION['mytype'])=='student'){
...
$query = "SELECT * FROM attendance_table WHERE class_number='$class_number' AND first_name='$first_name' ORDER BY ".$_POST["column_name"]." ".$_POST["order"]."";  
